module ScalarsMixed exposing
    ...
    , encodeScalarsMixedVariables
    , scalarsMixed
    , scalarsMixedVariablesDecoder
    )
...
scalarsMixedVariablesDecoder : Json.Decode.Decoder ScalarsMixedVariables
scalarsMixedVariablesDecoder =
    Json.Decode.map2 ScalarsMixedVariables
